...
# This version will track the users score in the GUI window instead of outputting
# ... at the end
# The category the user uses is still hardcoding but this will be change to a
# ... combobox in the upcoming versions
# Added a temporary Entry box in the place as the users name label so that they can
...
class Category:
    ...
    def createQuizWindow(self,quizMaster):
        ...
        self.quizMaster.geometry('1400x940')
        ...
        self.backgroundImageVar = PhotoImage(file="images/background.png")
        ...
        self.categoryFrame.place(x=50,y=50,width=1300,height=150)
        ...
        self.categoryTextLabel = Label(self.categoryFrame,textvariable=self.categoryTextVar,bg=BACKGROUND_COLOR1,fg=TEXT_COLOR,font=("Arial",80),padx=14,anchor="n")
        ...
        self.categoryTextLabel.place(x=6,y=6,width=1288,height=138)
        ...
        self.infoFrame.place(x=950,y=250,width=400,height=640)
        ...
        self.userNameFrame.place(x=18,y=18,width=364,height=64)
        ...
        self.userNameLabel = Entry(self.userNameFrame,textvariable = self.userNameVar,bg=BACKGROUND_COLOR1,fg=TEXT_COLOR,font=("Arial",17,"bold"),justify='left')
        # This is then placed in the corect position so that the user is able to enter their username
        self.userNameLabel.place(x=4,y=4,width=356,height=56)
        ...
        self.userScoreFrame.place(x=18,y=98,width=364,height=64)
        ...
        self.userScoreLabel = Label(self.userScoreFrame,textvariable = self.userScoreVar,bg=BACKGROUND_COLOR1,fg=TEXT_COLOR,font=("Arial",17,"bold"),padx=10,pady=10,anchor="w")
        # This is then placed within the user score frame
        self.userScoreLabel.place(x=4,y=4,width=356,height=56)
        ...
        self.exitWindowFrame.place(x=208,y=558,width=174,height=64)
        # I am then creating a button which is used to exit the game
        self.exitWindowButton = Button(self.exitWindowFrame,text="Exit Quiz",bg=BACKGROUND_COLOR1,fg=TEXT_COLOR,font=("Arial",17,"bold"),padx=10,pady=10,relief="flat",activebackground=BACKGROUND_COLOR2,activeforeground=TEXT_COLOR,command=self.quit)
        # It is then placed within the exitWindowFrame
        self.exitWindowButton.place(x=4,y=4,width=166,height=56)
        ...
        for num,question in enumerate(self.questions):
            ...
            qScore = question.createQuestions(self.quizMaster,(num + 1))
