...
# In this version I have added a restart quiz button qhich will let the user
# ... restart the quiz.
# I have also implemented a combo box used to select the category of the quiz.
# ... When the restart button is pressed the quiz will restart and the new
